...
(() => {
    ...
    const defaults = Object.freeze({ language: 'en', enabled: true, avatars: true, noComments: true,
        cacheMinutes: 2, autoRefresh: false, timeZone: 'local', localStats: false });
    const en = {
        autoRefresh: 'Auto-refresh', autoEnable: 'Enable auto-refresh (every {n} minutes)',
        autoPause: 'Pause auto-refresh (every {n} minutes)', refreshFailed: '{n} refresh failed',
        refreshNotYet: 'No successful check yet. Use Refresh visible to retry.',
        refreshAgeHint: 'Visible results: {done}/{total} checked. Oldest check: {oldest}. Newest check: {latest}. The label uses the oldest successful check, not the last request attempt.',
        refreshHelp: 'Auto-refresh is off by default. Returning to a tab keeps its last results. Refresh visible updates the items on screen. Enable auto-refresh to check them at the selected interval while this tab is visible; tab return starts a new interval, not an immediate refresh.',
        older: "Previous comment",
        newer: "Next comment",
        latest: "Latest comment",
        firstComment: "First comment",
        historyLoading: "Loading…",
        historyTrail: "Comment authors, oldest to newest",
        historyPaused: "Resume fetching to load older comments.",
        historyError: "Could not load the previous comment. Retry.",
        error_HISTORY_ANCHOR: "This comment changed or was deleted. Return to the latest comment and retry.",
        note: "Personal note",
        noteEdit: "Edit note",
        notePlaceholder: "Write a note for this issue…",
        notePinned: "Always show",
        noteSave: "Save",
        noteDelete: "Delete note",
        noteLocal: "Only on this device",
        noteSaved: "Saved",
        noteDiscard: "Discard unsaved changes to this note?",
        noteDeleteConfirm: "Delete this note from this device?",
        noteConflict: "This note changed in another tab. Your draft is preserved.",
        noteOverwrite: "Save my version",
        noteLoadError: "Could not read this note. Please retry.",
        noteSaving: "Saving…",
        noteDraft: "Unsaved draft",
        noteDeleted: "Note deleted",
        notesPrivacy: "Personal notes are stored locally under hashed issue keys until deleted or the extension is removed. They are not synced, encrypted by this extension, or included in diagnostics or usage exports. Notes are shared within this Chrome profile and are not GitHub comments. Like other displayed page content, notes rendered on GitHub are not a secure secrets vault.",
        notesHelp: "Use the note icon next to a badge to write a device-local note. Save it with the Save button or Ctrl/⌘+Enter. Always show pins it below the badge; otherwise hover over the note icon. Use Previous comment inside a preview to browse backwards, one comment at a time.",
        ...
        cacheMinutes: 'Auto-refresh interval', minutes: '{n} minutes', timeZone: 'Time zone', local: 'Device time zone', seoul: 'Seoul (UTC+9)', utc: 'UTC',
        ...
        welcomeStep2: 'Read the latest reply at a glance', welcomeBody2: 'Hover over a badge to read formatted Markdown and browse earlier comments.',
        welcomeStep3: 'Make it yours', welcomeBody3: 'Choose your language, time zone, avatars, and optional auto-refresh. Keep results until you refresh.',
        ...
        openSettings: 'Customize your experience', keyboard: 'Keyboard access', keyboardHelp: 'Tab to the author link to preview. Arrow Down or Space enters the preview; Escape closes it. Enter opens the comment. On touchscreens, tap the author to preview.',
        ...
        privacyTitle: 'Privacy policy', privacyEffective: 'Effective September 8, 2026 · Version 1.1.0',
        ...
        privacyRetention: 'Conversation data stays in page memory. Results are kept in page memory until refreshed, cleared, or the page closes; a bounded cache reuses recently detached list items. Auto-refresh is off by default. Route/account changes clear this memory. Preferences are stored in chrome.storage.local, not synchronized. Optional aggregate usage counters persist locally until deleted, disabled, or uninstalled.',
    ...
    const ko = {
        autoRefresh: '자동 갱신', autoEnable: '자동 갱신 켜기 ({n}분 간격)',
        autoPause: '자동 갱신 일시정지 ({n}분 간격)', refreshFailed: '갱신 실패 {n}개',
        refreshNotYet: '아직 확인한 결과가 없습니다. 보이는 항목 갱신으로 다시 시도할 수 있습니다.',
        refreshAgeHint: '화면에 보이는 {total}개 중 {done}개 확인. 가장 오래된 확인: {oldest}. 가장 최근 확인: {latest}. 표시 시간은 마지막 요청 시도가 아니라 가장 오래된 성공 조회를 기준으로 합니다.',
        refreshHelp: '자동 갱신은 기본으로 꺼져 있습니다. 다른 탭에서 돌아와도 마지막 결과를 유지합니다. 보이는 항목 갱신으로 직접 확인하거나 자동 갱신을 켜서 선택한 간격마다 확인할 수 있습니다. 자동 갱신 중에도 탭에 돌아온 직후에는 조회하지 않고 다음 간격까지 기다립니다.',
        older: "이전 댓글 보기",
        newer: "다음 댓글 보기",
        latest: "마지막 댓글로",
        firstComment: "첫 댓글",
        historyLoading: "불러오는 중…",
        historyTrail: "댓글 작성자 흐름, 과거부터 최근 순서",
        historyPaused: "이전 댓글을 불러오려면 조회를 재개해 주세요.",
        historyError: "이전 댓글을 불러오지 못했습니다. 다시 시도해 주세요.",
        error_HISTORY_ANCHOR: "댓글이 변경되었거나 삭제되었습니다. 마지막 댓글로 돌아가 다시 시도해 주세요.",
        note: "개인 메모",
        noteEdit: "메모 편집",
        notePlaceholder: "이 이슈에 대한 메모를 작성하세요…",
        notePinned: "항상 표시",
        noteSave: "저장",
        noteDelete: "메모 삭제",
        noteLocal: "이 기기에만 저장",
        noteSaved: "저장됨",
        noteDiscard: "저장하지 않은 메모 변경 내용을 버리시겠습니까?",
        noteDeleteConfirm: "이 기기에서 이 메모를 삭제하시겠습니까?",
        noteConflict: "다른 탭에서 메모가 변경되었습니다. 작성 중인 내용은 유지됩니다.",
        noteOverwrite: "내 내용으로 저장",
        noteLoadError: "메모를 읽지 못했습니다. 다시 시도해 주세요.",
        noteSaving: "저장 중…",
        noteDraft: "저장하지 않은 메모",
        noteDeleted: "메모 삭제됨",
        notesPrivacy: "개인 메모는 이슈 식별자의 해시를 키로 사용하여 삭제하거나 확장을 제거할 때까지 기기에 저장됩니다. 동기화하거나 확장 자체에서 암호화하지 않으며, 진단 정보나 사용 통계 내보내기에 포함하지 않습니다. 동일한 Chrome 프로필 안에서 사용하는 개인 메모이며 GitHub 댓글로 등록되지 않습니다. GitHub 페이지에 표시된 메모는 다른 화면 내용처럼 보안 저장소로 취급할 수 없으므로 비밀번호 등을 저장하지 마세요.",
        notesHelp: "배지 옆 메모 아이콘에서 기기에 저장되는 개인 메모를 작성할 수 있습니다. 저장 버튼이나 Ctrl/⌘+Enter로 저장하세요. 항상 표시를 켜면 배지 아래에 고정되고, 끄면 메모 아이콘에 마우스를 올릴 때 표시됩니다. 댓글 미리보기의 이전 댓글 보기 버튼으로 한 번에 하나씩 과거 댓글을 확인할 수 있습니다.",
        ...
        enabled: 'GitHub에서 사용', avatars: '작성자 아바타 표시', noComments: '댓글이 없는 항목도 표시', cacheMinutes: '자동 갱신 간격', minutes: '{n}분', timeZone: '시간대', local: '기기 시간대', seoul: '서울 (UTC+9)', utc: 'UTC',
        ...
        privacyRetention: '대화 정보는 페이지 메모리에만 보관합니다. 표시 중인 결과는 갱신, 삭제 또는 페이지 종료 시까지 유지하며 최근 목록 항목은 개수 제한이 있는 메모리 캐시에서 재사용합니다. 자동 갱신은 기본으로 꺼져 있습니다. 경로나 계정 변경 시 해당 메모리를 비웁니다. 설정은 동기화하지 않고 chrome.storage.local에 저장합니다. 선택적 사용 횟수는 삭제, 기능 해제 또는 확장 제거 시까지 기기에 보관됩니다.',
    ...
    function normalize(raw = {}) {
        if (!raw || typeof raw !== 'object' || Array.isArray(raw))
            raw = {};
        const p = { ...defaults };
        for (const key of ['enabled', 'avatars', 'noComments', 'localStats', 'autoRefresh'])
